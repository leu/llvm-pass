...
foreach(_expectedTarget LLVMHello LLVMFuncBlocCounter LLVMTestingSupport FileCheck llvm-PerfectShuffle count not yaml-bench BugpointPasses lli-child-target Bye TestPlugin gtest gtest_main)
...
# Create imported target LLVMFuncBlocCounter
add_library(LLVMFuncBlocCounter MODULE IMPORTED)
...
set_target_properties(LLVMHello PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "/home/leu/Documents/dev/llvm-pass/build/lib/LLVMHello.so"
  IMPORTED_NO_SONAME_DEBUG "TRUE"
  )

# Import target "LLVMFuncBlocCounter" for configuration "Debug"
set_property(TARGET LLVMFuncBlocCounter APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(LLVMFuncBlocCounter PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_DEBUG ""
  IMPORTED_LOCATION_DEBUG "/home/leu/Documents/dev/llvm-pass/build/lib/LLVMFuncBlocCounter.so"
  IMPORTED_NO_SONAME_DEBUG "TRUE"
  )
...
set_target_properties(LLVMTestingSupport PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "/home/leu/Documents/dev/llvm-pass/build/lib/libLLVMTestingSupport.a"
  )
...
set_target_properties(FileCheck PROPERTIES
  IMPORTED_LOCATION_DEBUG "/home/leu/Documents/dev/llvm-pass/build/bin/FileCheck"
  )
...
set_target_properties(llvm-PerfectShuffle PROPERTIES
  IMPORTED_LOCATION_DEBUG "/home/leu/Documents/dev/llvm-pass/build/bin/llvm-PerfectShuffle"
  )
...
set_target_properties(count PROPERTIES
  IMPORTED_LOCATION_DEBUG "/home/leu/Documents/dev/llvm-pass/build/bin/count"
  )
...
set_target_properties(not PROPERTIES
  IMPORTED_LOCATION_DEBUG "/home/leu/Documents/dev/llvm-pass/build/bin/not"
  )
...
set_target_properties(yaml-bench PROPERTIES
  IMPORTED_LOCATION_DEBUG "/home/leu/Documents/dev/llvm-pass/build/bin/yaml-bench"
  )
...
set_target_properties(BugpointPasses PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_DEBUG ""
  IMPORTED_LOCATION_DEBUG "/home/leu/Documents/dev/llvm-pass/build/lib/BugpointPasses.so"
  IMPORTED_NO_SONAME_DEBUG "TRUE"
  )
...
set_target_properties(lli-child-target PROPERTIES
  IMPORTED_LOCATION_DEBUG "/home/leu/Documents/dev/llvm-pass/build/bin/lli-child-target"
  )
...
set_target_properties(Bye PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_DEBUG ""
  IMPORTED_LOCATION_DEBUG "/home/leu/Documents/dev/llvm-pass/build/lib/Bye.so"
  IMPORTED_NO_SONAME_DEBUG "TRUE"
  )
...
set_target_properties(TestPlugin PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_DEBUG ""
  IMPORTED_LOCATION_DEBUG "/home/leu/Documents/dev/llvm-pass/build/unittests/Passes/TestPlugin.so"
  IMPORTED_NO_SONAME_DEBUG "TRUE"
  )
...
set_target_properties(gtest PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "/home/leu/Documents/dev/llvm-pass/build/lib/libgtest.a"
  )
...
set_target_properties(gtest_main PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "/home/leu/Documents/dev/llvm-pass/build/lib/libgtest_main.a"
  )
